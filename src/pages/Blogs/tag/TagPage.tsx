...
import {deleteBlogTag, getBlogTagPagination} from "../../../api/blog/blog_tag.ts";
import {TagFormPage} from "./components/TagFormPage.tsx";
...
export default function TagPage() {
    ...
    const [dataEdit, setDataEdit] = useState<BlogTag | null>(null);
    ...
    return (
        <>
            <PageMeta
                title="Saetechnology - Blogs - Tag"
                description="Saetechnology - Blogs - Tag"
            />
            <PageBreadcrumb pageTitle="Tag" />
            ...
            <TagFormPage dataEdit={dataEdit} isModalOpen={isModalOpen} setIsModalOpen={() => {
