...
import {deleteBlogCategory, getBlogCategoryPagination} from "../../../api/blog/blog_category.ts";
import {CategoryFormPage} from "./components/CategoryFormPage.tsx";
...
export default function CategoryPage() {
    ...
    const [dataEdit, setDataEdit] = useState<BlogCategory | null>(null);
    ...
    return (
        <>
            <PageMeta
                title="Saetechnology - Blogs - Category"
                description="Saetechnology - Blogs - Category"
            />
            ...
            <CategoryFormPage dataEdit={dataEdit} isModalOpen={isModalOpen} setIsModalOpen={() => {
